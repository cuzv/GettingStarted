...
@class VLocationPickerView;

@protocol VLocationPickerDelegate <NSObject>

@optional
- (void)locationPickerViewWillAppear:(VLocationPickerView *)locationPickerView;
- (void)locationPickerViewDidAppear:(VLocationPickerView *)locationPickerView;
- (void)locationPickerViewWillDisAppear:(VLocationPickerView *)locationPickerView;
- (void)locationPickerViewDidDisAppear:(VLocationPickerView *)locationPickerView;

- (void)locationPickerView:(VLocationPickerView *)locationPickerView didSelectItem:(NSString *)item;
...
@interface VLocationPickerView : UIView

@property (nonatomic, assign) id <VLocationPickerDelegate> delegate;
